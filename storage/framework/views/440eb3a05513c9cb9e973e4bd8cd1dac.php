                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <input type="hidden" name="idBookEdit" id="idBookEdit" value="<?php echo e($dataBook[0]->id); ?>">
                                        <div class="form-group">
                                            <label for="txtNameEdit" class="bmd-label-floating">Name</label>
                                            <input type="text" class="form-control" name="txtNameEdit" id="txtNameEdit" maxlength="255" value="<?php echo e($dataBook[0]->name); ?>">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="txtPublishedDateEdit" id="txtPublishedDateEdit" value="<?php echo e($dataBook[0]->published_date); ?>">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txtAuthorEdit" id="txtAuthorEdit" maxlength="255" value="<?php echo e($dataBook[0]->author); ?>">
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Archivos de programa\xampp\htdocs\libraryexam\resources\views/admin/updatebook.blade.php ENDPATH**/ ?>